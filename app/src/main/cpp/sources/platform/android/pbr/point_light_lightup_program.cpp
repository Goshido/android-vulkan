...
#include <platform/android/pbr/point_light_lightup_program.hpp>
...
bool PointLightLightupProgram::Init ( android_vulkan::Renderer const &renderer,
...
VkPipelineLayout PointLightLightupProgram::InitLayout ( VkDevice device ) noexcept
{
...
VkPipelineShaderStageCreateInfo const* PointLightLightupProgram::InitShaderInfo (
