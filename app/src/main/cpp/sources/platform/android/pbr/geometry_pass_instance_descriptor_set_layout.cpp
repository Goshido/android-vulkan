...
#include <platform/android/pbr/geometry_pass_instance_descriptor_set_layout.hpp>
...
bool DescriptorSetLayout::Init ( VkDevice device ) noexcept
{
    ...
    AV_SET_VULKAN_OBJECT_NAME ( device, _layout, VK_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT, "Geometry pass instance" )
    return true;
}
