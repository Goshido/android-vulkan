...
local function GetX ( self, x )
    ...
    assert ( type ( x ) == "table" and x._type == eObjectType.GXVec3, [[GXMat3:GetX - "x" is not a GXVec3.]] )
...
local function GetY ( self, y )
    ...
    assert ( type ( y ) == "table" and y._type == eObjectType.GXVec3, [[GXMat3:GetY - "y" is not a GXVec3.]] )
...
local function GetZ ( self, z )
    ...
    assert ( type ( z ) == "table" and z._type == eObjectType.GXVec3, [[GXMat3:GetZ - "z" is not a GXVec3.]] )
...
local function Inverse ( self, sourceMatrix )
    ...
    assert ( type ( sourceMatrix ) == "table" and sourceMatrix._type == eObjectType.GXMat3,
...
local function Multiply ( self, a, b )
    ...
    assert ( type ( a ) == "table" and a._type == eObjectType.GXMat3, [[GXMat3:Multiply - "a" is not a GXMat3.]] )
    assert ( type ( b ) == "table" and b._type == eObjectType.GXMat3, [[GXMat3:Multiply - "b" is not a GXMat3.]] )
...
local function SetX ( self, x )
    ...
    assert ( type ( x ) == "table" and x._type == eObjectType.GXVec3, [[GXMat3:SetX - "x" is not a GXVec3.]] )
...
local function SetY ( self, y )
    ...
    assert ( type ( y ) == "table" and y._type == eObjectType.GXVec3, [[GXMat3:SetY - "y" is not a GXVec3.]] )
...
local function SetZ ( self, z )
    ...
    assert ( type ( z ) == "table" and z._type == eObjectType.GXVec3, [[GXMat3:SetZ - "z" is not a GXVec3.]] )
