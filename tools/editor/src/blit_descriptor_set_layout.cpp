...
bool DescriptorSetLayout::Init ( VkDevice device ) noexcept
{
    ...
    bool const result = android_vulkan::Renderer::CheckVkResult (
        ...
        "editor::BlitDescriptorSetLayout::Init",
    ...
    AV_SET_VULKAN_OBJECT_NAME ( device, _layout, VK_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT, "Blit" )
...
void BlitDescriptorSetLayout::Destroy ( VkDevice device ) noexcept
{
    g_descriptorSetLayout.Destroy ( device );
}

bool BlitDescriptorSetLayout::Init ( VkDevice device ) noexcept
{
    return g_descriptorSetLayout.Init ( device );
}

VkDescriptorSetLayout &BlitDescriptorSetLayout::GetLayout () const noexcept
{
