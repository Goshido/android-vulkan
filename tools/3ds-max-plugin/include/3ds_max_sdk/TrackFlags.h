...
#define ADJTAN_BREAK	(1<<1) // If set, break the tangent handles.
#define ADJTAN_ABSOLUTE (1<<2) // If set, adjust tangent handle to an absolute value; if unset, by a relative amount
#define ADJTAN_ANGLE    (1<<3) // If set, adjust the angle of the tangent handle
#define ADJTAN_LENGTH   (1<<4) // If set, adjust the length of the tangent handle
