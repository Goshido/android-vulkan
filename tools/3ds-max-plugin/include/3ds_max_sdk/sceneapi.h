...
class IScene: public MaxHeapOperators {		
	public:
		...
		\param bIgnoreRoot false to include scene root node, true otherwise.
		\return  Nonzero if the process was aborted by the callback
		(<b>TREE_ABORT</b>); otherwise 0. */
		virtual int EnumTree( ITreeEnumProc* proc, bool bIncludeXRef = false, bool bIgnoreRoot = true)=0;
		/*! \remarks Implemented by the System.\n\n
