...
) noexcept
{
    ...
    AV_SET_VULKAN_OBJECT_NAME ( device, _pipeline, VK_OBJECT_TYPE_PIPELINE, "pbr::ReflectionGlobalProgram::_pipeline" )
...
GraphicsProgram::DescriptorSetInfo const &ReflectionGlobalProgram::GetResourceInfo () const noexcept
{
...
bool ReflectionGlobalProgram::InitLayout ( VkDevice device, VkPipelineLayout &layout ) noexcept
{
    ...
    AV_SET_VULKAN_OBJECT_NAME ( device,
        ...
        "pbr::ReflectionGlobalProgram::_pipelineLayout"
    )
