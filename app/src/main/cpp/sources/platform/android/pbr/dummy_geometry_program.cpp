...
#include <platform/android/pbr/dummy_geometry_program.hpp>
...
constexpr uint32_t COLOR_RENDER_TARGET_COUNT = 4U;
...
VkPipelineColorBlendStateCreateInfo const* DummyGeometryProgram::InitColorBlendInfo (
...
VkPipelineDepthStencilStateCreateInfo const* DummyGeometryProgram::InitDepthStencilInfo (
