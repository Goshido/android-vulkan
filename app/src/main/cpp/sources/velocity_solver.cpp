...
constexpr uint16_t ITERATIONS = 7U;
constexpr float STABILIZATION_FACTOR = 0.21F;
constexpr float PENETRATION_SLOPE = 5.0e-4F;
constexpr float RESTITUTION_SLOPE = 5.0e-1F;
