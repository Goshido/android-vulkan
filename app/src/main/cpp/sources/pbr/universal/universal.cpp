...
Universal::Universal ( std::string &&sceneFile ) noexcept:
    _sceneFile ( std::move ( sceneFile ) )
{
    // NOTHING
}

bool Universal::IsReady () noexcept
{
    return _isReady;
}

bool Universal::OnFrame ( android_vulkan::Renderer &renderer, double deltaTime ) noexcept
{
...
bool Universal::OnInitDevice ( android_vulkan::Renderer &renderer ) noexcept
{
    ...
    bool result = android_vulkan::Renderer::CheckVkResult (
        ...
        "pbr::universal::Universal::OnInit",
    ...
    AV_REGISTER_COMMAND_POOL ( "pbr::universal::Universal::_commandPool" )
...
void Universal::OnDestroyDevice ( android_vulkan::Renderer &renderer ) noexcept
{
...
bool Universal::OnSwapchainCreated ( android_vulkan::Renderer &renderer ) noexcept
{
...
void Universal::OnSwapchainDestroyed ( android_vulkan::Renderer &renderer ) noexcept
{
    _scene.OnPause ();
    _physics.Pause ();
...
bool Universal::OnInitSoundSystem () noexcept
{
    return _scene.OnInitSoundSystem ();
}

void Universal::OnDestroySoundSystem () noexcept
{
    _scene.OnDestroySoundSystem ();
}

bool Universal::CreatePhysics () noexcept
{
    ...
    android_vulkan::LogError ( "pbr::universal::Universal::CreatePhysics - Can't add gravity." );
    return false;
}

void Universal::DestroyCommandPool ( VkDevice device ) noexcept
{
    ...
    AV_UNREGISTER_COMMAND_POOL ( "pbr::universal::Universal::_commandPool" )
}
