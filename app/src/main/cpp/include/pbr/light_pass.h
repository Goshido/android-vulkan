...
{
    private:
        constexpr static size_t const INPUT_ATTACHMENTS = 3U;
    ...
    private:
        ...
        void CreateImageBarriers ( GBuffer &gBuffer );
        ...
        [[nodiscard]] bool CreateUnitCube ( android_vulkan::Renderer &renderer, VkCommandPool commandPool );
};
