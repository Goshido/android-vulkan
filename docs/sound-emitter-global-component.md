...
Methods returns the volume of the emitter.
...
Methods sets the volume of the emitter.
...
Methods tells if the emitter is playing sound or not.
...
Methods sets the playing of sound on pause.
...
Methods sets sound asset for playing.
