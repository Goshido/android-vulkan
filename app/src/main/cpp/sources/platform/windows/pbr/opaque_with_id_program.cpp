...
bool OpaqueWithIDProgram::Init ( VkDevice device, VkFormat depthStencilFormat ) noexcept
{
...
VkPipelineColorBlendStateCreateInfo const* OpaqueWithIDProgram::InitColorBlendInfo (
...
VkPipelineRenderingCreateInfo const* OpaqueWithIDProgram::InitRenderingInfo ( VkFormat /*nativeColor*/,
