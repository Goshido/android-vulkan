...
class PointLightComponent final : public Component
{
    ...
    public:
        explicit PointLightComponent ( MessageQueue &messageQueue ) noexcept;
        ...
        explicit PointLightComponent ( MessageQueue &messageQueue, SaveState::Container const &info ) noexcept;
